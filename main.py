...
# Nos olvidamos del viejo cerebro y llamamos al nuevo
...
def mostrar_pre_nido(id_unico):
    ...
    conn = None
    try:
        # Usamos DATABASE_URL para esta parte, como en tu código original
        ...
        """ # Omitido por brevedad, pero es tu prompt original
...
def generar_nido_y_enviar_enlace():
    ...
    datos_del_nido = {
        ...
        # ... (el resto de tus datos de prueba) ...
    }
